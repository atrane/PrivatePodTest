...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/atrane/GMGridView"
  ...
  s.author             = { "Atul Rane" => "email@address.com" }
  # Or just: s.author    = "Atul Rane"
  # s.authors            = { "Atul Rane" => "email@address.com" }
  # s.social_media_url   = "http://twitter.com/Atul Rane"
  ...
  s.source       = { :git => "https://github.com/atrane/GMGridView.git", :tag => "v1.1.1" }
